...
compared to e.g.~some US states (if left, need citations). Also talk
about trust in government here.

\noindent The data analysis has been carried out in R using the
\textit{tidysynth} and \textit{SCtools} packages, generating synthetic
