...
analysis is performed, with respect to the additional predictor
variables and the donor pool countries. Each country and predictor is
left out of the constrained minimization once, while holding all other
specifications constant.

The synthetic control analysis is carried out in R using the synth and
...
To begin with, a regression discontinuity design is utilized to estimate
...
\begin{center}\includegraphics{bachelor_thesis_files/figure-latex/unnamed-chunk-8-1} \end{center}



\begin{center}\includegraphics{bachelor_thesis_files/figure-latex/unnamed-chunk-8-2} \end{center}
\end{figure}
